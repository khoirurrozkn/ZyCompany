...
const Hero = () => {
  return (
    <div className='px-[1rem] md:px-[2rem] lg:px-[5rem] flex items-center bg-news text-white flex h-[100vh] object-top'>
        <div className='font-[600]'>
        <div className='flex'>
            <div className='bg-sky-500 py-1 px-3 rounded-lg me-3'>PREMIUM</div>
            <div className='bg-red-500 py-1 px-3 rounded-lg'>21+</div>
        </div>
        <p className='text-[2rem] font-[600] md:text-[4rem] tracking-tight leading-[130%]'>
            World War III : 
            <br></br>
            The New Chapter
        </p>
        ...
        <p className='w-[90%] md:w-[60%]'><span className='text-red-500'>Synopsis : </span>
