    ...
    return (
        <div>
            ...
            <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718316342/foto-home-1_obwu2r.jpg'
                ...
                className='container mx-auto w-[100%] lg:h-[70vh] object-cover mt-[2rem] brightness-[80%]'>
            </img>
            ...
            <div className='container mx-auto flex flex-wrap justify-between items-center py-[30px]'>
                ...
                <div className='flex flex-wrap lg:w-[70%] md:w-[70%] text-lg text-white justify-around'>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718318755/logo-1_isdmia.png' alt='growth tv' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718319316/logo-8_ijhb23.png' alt='whoosh tv' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718319317/logo-6_vpxhcz.png' alt='caps radio' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718319317/logo-4_hsqfcf.png' alt='rand tv' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718319317/logo-3_gzmnzk.png' alt='radio 007' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                    <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718319316/logo-7_hfzwps.png' alt='62 tv' className='aspect-square w-[15%] md:w-[60px] lg:w-[60px] mt-2 lg:mt-0 rounded-lg'></img>
                </div>
            </div>
        </div>
    )
