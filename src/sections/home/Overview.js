  ...
  return (
    <>
        <div className='container mx-auto flex flex-wrap justify-evenly items-center'>
            <img src='https://res.cloudinary.com/dobjgx7ps/image/upload/v1718525246/foto-home-2_xj8hai-ezgif.com-jpg-to-webp-converter_PC_TABLET_nig0a0.webp'
            ...
            <div className='lg:w-[40%] order-1 lg:order-2'>
                <p className='text-[2rem] md:text-[2.5rem] lg:text-[3rem] lg:mb-[2rem] font-[600] tracking-tight leading-[130%]'>Zy.Company <span className='underline font-[600] underline-offset-4 decoration-sky-500'>Overview</span></p>
                <DescDropdown 
        ...
        <ButtonHome to={"/about"} additional={"bg-[#0EA5E9] mt-[2rem] order-3 md:hidden text-white"}>
                About us 
        </ButtonHome>
    </>
  )
